...
function gen.genChunk(w,x,y)
  ...
  for i = 1,world.chunkSize do
    ...
    if love.math.random(1,10000) > 9800 and upa and (i > 0 and i < 16) and upa+th+1 < 17 and d[i] and d[i][upa+1] and d[i][upa+1].tile and (d[i][upa+1].tile.id == 2 or d[i][upa+1].tile.id == 3) then
